  ...
  <div class="mcategory">
    ...
    <el-button type="primary" @click="addCategoryToServer">添加</el-button>
      ...
      <el-dialog
        ...
        width="30%">
        <el-input style="margin-bottom: 2rem" placeholder="菜单名" v-model="editCategoryData.Name"></el-input>
        <el-input style="margin-bottom: 2rem" placeholder="菜单描述" v-model="editCategoryData.Description"></el-input>
        <span slot="footer" class="dialog-footer">
